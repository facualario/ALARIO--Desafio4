...
let producto = parseInt(prompt("Ingrese la cantidad de productos que desea"))

let amount = producto * 500
...
function calculoiva (){
    ...
    console.log("El precio unitario es de $500 y el total de unidades que desea con iva incluido es de " + iva)
